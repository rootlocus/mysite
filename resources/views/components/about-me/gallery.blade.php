<div class="mx-auto max-w-2xl">
    ...
    <div class="shadow-2xl relative">
        ...
        <div class="w-full object-cover">
            <img src="{{ asset('images/monk.png') }}" src="#" onclick="currentSlide(3)" alt="Globe">
        </div>
        </div>
        <div class="mySlides hidden">
        ...
        <div>
            <img src="http://localhost/images/monk.png" src="#" onclick="currentSlide(3)" class="description h-24 opacity-50 hover:opacity-100 cursor-pointer" alt="Globe" onclick="currentSlide(3)">
