<form class="w-full max-w-lg" wire:submit.prevent="submit">
    ...
    <div class="md:flex md:items-center">
      <div class="md:w-1/3">
        <button class="shadow bg-indigo-800 hover:bg-indigo-800 focus:shadow-outline focus:outline-none text-white font-bold py-2 px-4 rounded content" type="submit">
          Send
        </button>
      </div>
