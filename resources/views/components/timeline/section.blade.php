<div class="mb-8 flex justify-between items-center w-full {{$direction}}" :class="{}">
    ...
    <div class="order-1 bg-indigo-800 rounded-lg shadow-xl w-5/12 px-6 py-4">
        <h3 class="mb-1 font-bold text-white text-xl hover:underline"><a href="{{$titleLink}}" target="_blank">{{ $title }}</a></h3>
