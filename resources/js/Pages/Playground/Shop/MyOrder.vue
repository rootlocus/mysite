            ...
            <div class="flex flex-row space-x-10 mb-10">
                <div class="bg-gray-300 w-full flex flex-col p-4 ">
                    ...
                    <div class="flex flex-col border-double border-b-4 border-black mt-2" v-for="item in orders" :key="item.id">
                        ...
                        <div class="flex flex-row font-bold space-x-2 mb-2">
                        ...
                        <div @click="viewProductPage(item.product.id)" class="flex flex-row space-x-2 mb-2 text-gray-700 cursor-pointer hover:text-blue-800 font-semibold hover:bg-blue-200" v-for="item in item.items" :key="item.id">
                        ...
                        <div class="border-1 border-t-4 border-black flex flex-row pt-2 space-x-6 mb-10">
