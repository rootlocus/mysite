    ...
    <div class="min-h-screen bg-white pt-12">
        ...
        <div class="flex flex-col lg:mx-40 md:mx-10 mt-5">
            ...
            <div class="flex flex-row space-x-10 mb-10">
                <div class="w-1/2"  v-if="Object.keys(cart.items).length > 0">
                ...
                <div class="bg-gray-300 w-1/2 flex flex-col p-4 ">
                    ...
                    <div class="flex flex-col space-y-4">
                        ...
                        <button class="p-4 bg-gray-750 text-gray-300 hover:opacity-80 disabled:opacity-50 disabled:cursor-not-allowed rounded" @click="checkout" :disabled="!cart.items_count">
                            Checkout Now
                        </button>
                    </div>
                </div>
