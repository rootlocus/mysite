<template>
    ...
    <div class="min-h-screen bg-white pt-12">
        ...
        <div class="flex flex-col p-1 lg:mx-96 md:mx-10 mt-5 px-4 rounded">
            <div class="mb-2">
                <div class="flex space-x-4">
                    <button @click="isToggle = !isToggle" class="px-2 py-1 bg-gray-750 text-gray-300 hover:opacity-80 disabled:opacity-50 disabled:cursor-not-allowed rounded">
                        Add Address
                    </button>
                </div>
            </div>
        </div>
        <div v-if="isToggle" class="bg-gray-300 flex flex-col p-4 lg:mx-96 md:mx-10 mt-2 px-10 rounded border-2 border-black">
            <div>
        ...
        <div class="flex flex-col p-4 lg:mx-96 md:mx-10 mt-2" v-if="Object.keys(addresses).length > 0">
            <AddressList :addresses="addresses"/>
        </div>
        <div v-else class="bg-gray-300 flex flex-col p-4 lg:mx-96 md:mx-10 mt-2 px-10 rounded border-2 border-black">
