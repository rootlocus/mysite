<template>
    <div class="text-black md:h-10 bg-gray-300 flex justify-between md:px-20 px-10 py-2">
        <div class="flex items-center space-x-4">
            ...
            <Link class="flex flex-col md:flex-row items-center space-x-2 hover:text-blue-800" href="/playground/shop/my-orders">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 8h14M5 8a2 2 0 110-4h14a2 2 0 110 4M5 8v10a2 2 0 002 2h10a2 2 0 002-2V8m-9 4h4" />
                </svg>
                <span>MY ORDERS</span>
            </Link>
            <div class="flex flex-col md:flex-row items-center space-x-2 hover:text-blue-800">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
